...
contract thesis is Ownable{
    ...
    */
    ...
    /*
    * @desc Returns the owner of the given device ID
    * @param deviceID The ID of the device which owner is needed 
    * @return The owner of the specified device
    */
    ...
    /*
    * @desc Registers to the specified device ID the specified owner
    ...
    */
    ...
    /*
    * @desc Transfers to the address of the owner of the specified device ID the specified amount of coins from the specified address
    * @param deviceID The ID of the device which owner will receive the coins
    * @param from The address whose coins will be transfered
    * @param amount The amount of coins that will be transfered
    */
